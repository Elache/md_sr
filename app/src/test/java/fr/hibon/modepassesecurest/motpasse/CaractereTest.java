...
public class CaractereTest {
	...
	private final ArrayList<Character> echantillon;
	...
	/**
	 * Verifie setter de getLeChar() (char) <BR>
	 * Test : set d'un caractere : le retrouver avec un get
	 */
	@Test
	public void setLeChar_char_doitModifier() {
	 ...
	 */
	@Test
	public void setLeChar_int_doitModifier() {
		Caractere c = new Caractere('1');
		c.setLeChar(121); // caractere 121
		assertEquals('y', c.getLeChar());
	}
